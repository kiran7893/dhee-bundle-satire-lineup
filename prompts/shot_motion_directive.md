...
1. NAME the on-screen character (id {{item_id}}) and identify it by visible appearance (e.g. "the buffalo contractor in the wooden chair", "the cauliflower news anchor with the microphone") so the model animates the right face.
